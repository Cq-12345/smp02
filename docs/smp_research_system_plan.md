...
- `scripts/build_process_approval_reviewer_checklist.py` 已把这 12 行审批模板转成 reviewer checklist；当前 12 行 ready for human review、0 行 submitted/accepted，可解锁 13 条 downstream high-fidelity protocol。
